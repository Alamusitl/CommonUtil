...
public class KSCStatusCode {
    ...
    public static final int NOT_INIT = 1200;// 登录失败，渠道未初始化或正在初始化
    ...
    private static final String MSG_NOT_INIT = "SDK not init, please init SDK ";
    ...
    private static final String MSG_PAY_RESULT_UNKNOWN = "Pay result unknown";
    ...
    static {
        ...
        mErrorInfoMap.put(String.valueOf(NOT_INIT), MSG_NOT_INIT);
        ...
        mErrorInfoMap.put(String.valueOf(PAY_RESULT_UNKNOWN), MSG_PAY_RESULT_UNKNOWN);
