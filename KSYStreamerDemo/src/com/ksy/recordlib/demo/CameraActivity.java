...
public class CameraActivity extends Activity {
    ...
    private final static String FRAME_RATE = "framerate";
    private final static String VIDEO_BITRATE = "video_bitrate";
    private final static String AUDIO_BITRATE = "audio_bitrate";
    private final static String VIDEO_RESOLUTION = "video_resolution";
    private final static String EncodeWithHEVC = "encode_with_hevc";
    private final static String LANDSCAPE = "landscape";
    private final static String ENCODE_METHOD = "ENCODE_METHOD";
    private final static String START_AUTO = "start_auto";
    private final static String FRONT_CAMERA_MIRROR = "front_camera_mirror";
    private final static String TEST_SW_FILTER = "testSWFilterInterface";
    private final static String MANUAL_FOCUS = "manual_focus";
    private final static String SHOW_DEBUGINFO = "SHOW_DEBUGINFO";
    private final static String START_STRING = "开始直播";
    private final static String STOP_STRING = "停止直播";
    ...
    private volatile boolean mActivityResumed = false;
    ...
    public static void startActivity(Context context, int fromType, String rtmpUrl, int frameRate, int videoBitrate, int audioBitrate,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (bundle != null) {
            ...
            encode_method = (KSYStreamerConfig.ENCODE_METHOD) bundle.get(ENCODE_METHOD);
            ...
            startAuto = bundle.getBoolean(START_AUTO, false);
    ...
    private void updateDebugInfo() {
        ...
        mDebugInfo = String.format(Locale.US, "RtmpHostIP()=%s DroppedFrameCount()=%d \n " +
